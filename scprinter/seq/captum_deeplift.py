...
class DeepLift(GradientAttribution):
    ...
    def _is_non_linear(self, module: Module) -> bool:
        return module.__class__.__name__ in SUPPORTED_NON_LINEAR.keys()
    ...
    def _backward_hook(
        ...
        # print (module, module.input.shape, module.output.shape,
        #        grad_input[0].shape, grad_output[0].shape)
        multipliers = SUPPORTED_NON_LINEAR[module.__class__.__name__](
            module,
            module.input,
            module.output,
            grad_input,
